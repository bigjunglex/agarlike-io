...
const file_common_packets_proto_rawDesc = "" +
	...
	"\x06reason\x18\x01 \x01(\tR\x06reason\"\x94\x03\n" +
	"\x06Packet\x12\x1b\n" +
...
var file_common_packets_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
...
func file_common_packets_proto_init() {
	...
	file_common_packets_proto_msgTypes[6].OneofWrappers = []any{
		(*Packet_Chat)(nil),
		(*Packet_Id)(nil),
