...
const file_common_packets_proto_rawDesc = "" +
	...
	"\bhiscores\x18\x01 \x03(\v2\x17.packets.HiscoreMessageR\bhiscores\"\xed\a\n" +
	"\x06Packet\x12\x1b\n" +
...
var file_common_packets_proto_msgTypes = make([]protoimpl.MessageInfo, 16)
...
func file_common_packets_proto_init() {
	...
	file_common_packets_proto_msgTypes[15].OneofWrappers = []any{
		(*Packet_Chat)(nil),
		(*Packet_Id)(nil),
